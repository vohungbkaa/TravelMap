...
abstract class BasePagingScreen<
  VM extends BasePagingViewModel<T, P>,
  T,
  P extends PagingParam
>
    extends BaseListScreen<VM, T, P> {
      ...
      onNotification: (ScrollNotification scrollInfo) {
        if (scrollInfo.metrics.axisDirection == AxisDirection.down) {
          ...
          if (maxScroll - currentScroll <= loadMoreThreshold) {
            unawaited(Future.microtask(() => viewModel.loadMore()));
          }
        }
        return false;
      },
